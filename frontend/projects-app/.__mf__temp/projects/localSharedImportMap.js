...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "@apollo/client": async () => {
          let pkg = await import("__mf__virtual/projects__prebuild___mf_0_apollo_mf_1_client__prebuild__.js");
            return pkg;
        }
      ,
        "react": async () => {
      ...
      ,
        "react-router-dom": async () => {
          let pkg = await import("__mf__virtual/projects__prebuild__react_mf_2_router_mf_2_dom__prebuild__.js");
            return pkg;
        }
